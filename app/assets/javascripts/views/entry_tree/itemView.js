// DeepThought.Views.ItemView = Backbone.View.extend({
//   //INPUT: MODEL
//   template: JST["entry_tree/form"],
//   tagName: "li",
//   render: function() {
...
// //     this.collection = new DeepThought.Collections.EntryTree(sortedChildren);
...
// //       this.model.collection.fetch({
// //         success: function(){
// //           that.model.save({parent_id: newParentID, rank:newRank});
